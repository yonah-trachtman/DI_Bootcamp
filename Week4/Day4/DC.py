...
cursor.execute("CREATE TABLE Countries (country_id serial primary key, name varchar(255), capital Varchar(255), flag varchar(max), subregion Varchar(255), population float)")
