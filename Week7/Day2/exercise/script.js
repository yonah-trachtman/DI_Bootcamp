...
const url2 = "https://api.giphy.com/v1/gifs/search?q=sun&rating=g&limit=10&offset=2&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My"
...
async function getStarship() {
    try {
      let starships = await fetch("https://www.swapi.tech/api/starships/9/");
...
// it will log calling then wait 2 seconds and print resolve
