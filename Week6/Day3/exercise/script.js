...
// the output will use the information from person like so
...
// all but object4 are 4 object4 is 5
...
class Mamal extends Animal {
    ...
    sound(soundItMakes) {
        console.log(`${soundItMakes} I'm a ${this.type}, named ${this.name} and I'm ${this.color}`)
    }
}
